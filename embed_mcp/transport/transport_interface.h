...
// Transport types
typedef enum { MCP_TRANSPORT_STDIO, MCP_TRANSPORT_HTTP } mcp_transport_type_t;
...
typedef void (*mcp_message_received_callback_t)(const char* message,
                                                size_t length,
...
typedef void (*mcp_transport_error_callback_t)(mcp_transport_t* transport,
                                               int error_code,
